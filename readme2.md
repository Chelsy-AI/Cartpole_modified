...
- [x] `results/final_eval.csv` exists with A and B results
- [x] `docs/experiment_brief.md` complete
- [x] `docs/experiment_results.md` complete
- [x] PR merged with approvals
...
### Week 19
- [x] Baseline trained and recorded
- [x] Eval protocol documented
- [x] Team roles assigned in runbook
- [x] PR workflow practiced
- [x] HPO sweep run (25+ trials)
- [x] Ship candidate selected with rationale
- [x] Individual Google Doc submitted

### Week 20
- [x] Ship candidate packaged with run steps
- [x] PR reviewed and merged
- [x] A/B experiment completed
- [x] Decision made (SHIP/ITERATE/REVERT)
- [x] Uncertainty documented
